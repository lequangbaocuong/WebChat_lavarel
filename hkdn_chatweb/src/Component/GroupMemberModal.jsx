...
const GroupMemberModal = ({ isShowMemberModal, closeModal, users, group, updateRoomUser }) => {
    ...
    const addSelectedUsers = () => {
        ...
        axios.post("http://localhost:8000/api/add-user-to-room", {
            room_id: roomId,
            emails: emails
        }, {
            // headers: {
    ...
    return (<>
        ...
        {showAddMember && (
            <div className="fixed inset-0 bg-gray-700 bg-opacity-75 flex items-center justify-center z-50">
                <div className="bg-white p-8 rounded-lg w-80 shadow-lg max-h-[calc(2/3*100%)] flex flex-col">
                    <div className="flex items-center justify-between mb-4">
